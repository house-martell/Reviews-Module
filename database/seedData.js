...
let ageRange = ['Under 18', '18-24', '25-34', '35-44', '45-54', '55-65', 'I keep my age on the DL'];
...
const randomlyGeneratedReviews = (num) => {
  for (var i = 0; i < num; i++) {
    holder.push({
      product_id: getRandomNumber(5),
      username: Sentencer.make('{{ noun }}' + getRandomNumber(100)),
